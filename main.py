...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument("--buffer-size", type=int, default=50000)  # 从100000减小到50000
    ...
    parser.add_argument("--batch-size", type=int, default=16)  # 从32减小到16
    parser.add_argument("--training-num", type=int, default=2)  # 从10减小到4
    parser.add_argument("--test-num", type=int, default=2)  # 从10减小到4
